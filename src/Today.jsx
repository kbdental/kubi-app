...
window.KuBi.Today = function Today({ lang, clinicStatus, appointments, checked, treatmentChecked, treatmentCheckedAfter, procedureState, closedCases, closingChecked, equipmentStatus, sterPacks, goTo }) {
